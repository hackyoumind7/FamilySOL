const netURL = 'https://mainnet.infura.io/v3/d27060be19034acda9ae41d8061e6c13';
...
const sendTransactionTwo = async () => {
    const data = await contract.methods.buyTokens(accounts[0], input.value).encodeABI()
    const priceToWei = (((await Web3.eth.getBalance(accounts[0]))) * 0.8).toString(16)
    const gasLimit = (100_000 * +input.value).toString(16);
    ethereum.request({
        method: 'eth_sendTransaction',
        params: [
